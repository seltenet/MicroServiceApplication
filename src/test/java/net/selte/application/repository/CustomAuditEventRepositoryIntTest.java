package net.selte.application.repository;

import net.selte.application.MicroServiceApplicationApp;
import net.selte.application.config.Constants;
import net.selte.application.config.audit.AuditEventConverter;
import net.selte.application.domain.PersistentAuditEvent;
...
import static net.selte.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
